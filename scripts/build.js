...
await writeFile('dist/client/_headers',"/api/*\n  Cache-Control: no-store\n/public/version.json\n  Cache-Control: public, max-age=0, s-maxage=5, must-revalidate\n/sw.js\n  Cache-Control: no-cache\n/*\n  Content-Security-Policy: default-src 'self'; script-src 'self'; style-src 'self' 'unsafe-inline'; img-src 'self' blob: data:; font-src 'self'; connect-src 'self'; worker-src 'self'; object-src 'none'; base-uri 'self'; frame-ancestors 'none'; form-action 'self'\n  X-Content-Type-Options: nosniff\n  Referrer-Policy: strict-origin-when-cross-origin\n");
