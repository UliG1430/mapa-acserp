...
async function leer(url){const r=await fetch(url,{cache:'no-cache',signal:AbortSignal.timeout(8000)});if(!r.ok)throw new Error('No se pudo cargar la publicación.');return r.json();}
